...
require 'kickstart.plugins.autoformat', require 'kickstart.plugins.debug' -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/custom/plugins/*.lua`
